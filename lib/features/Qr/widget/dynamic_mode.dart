...
class DynamicMode extends StatefulWidget {
  const DynamicMode({Key? key}) : super(key: key);

  @override
  State<DynamicMode> createState() => _DynamicModeState();
}

class _DynamicModeState extends State<DynamicMode> {
